    ...
    <el-card shadow="never" class="user-list-card">
      ...
      <el-table ref="multipleTableRef" :data="tableData" style="width: 100%" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="用户账号" width="150">
          <template #default="scope">
            <el-link style="color: #1677ff">
              <router-link @click="saveTab({ path: `/system/user/detail`, name: '用户详情' })"
                :to="{ path: '/system/user/detail', query: { id: scope.row.nickname } }">{{ scope.row.nickname
                }}</router-link>
            </el-link>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" align="center" width="200">
          <template #default="scope">
            <el-space spacer="|" style="color: #999" wrap><el-link type="primary" :id="scope.row.username"
