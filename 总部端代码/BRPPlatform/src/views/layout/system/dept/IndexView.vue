      ...
      <div class="dept-container">
        <div class="dept-aside">
          <div class="dept-aside-menu" :style="{ width: isShow ? '265px' : '0px' }">
            ...
            <el-scrollbar>
              <el-tree :data="data" :highlight-current="true" :default-expanded-keys="[1]" :props="defaultProps"
        ...
        <div class="dept-content">
          ...
          <div class="dept-user-table">
            <el-table ref="multipleTableRef" :data="tableData" :table-layout="'auto'" style="width: 100%"
              ...
              <el-table-column label="操作" align="center" width="200">
                <template #default="scope">
                  <el-space spacer="|" style="color: #999" wrap><el-link type="primary"
                      @click="userEditRef.init(scope.row)">修改</el-link>
