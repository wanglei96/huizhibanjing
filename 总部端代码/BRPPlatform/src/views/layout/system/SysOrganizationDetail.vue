...
//获取组织机构树
const getSysOrganizationTree = (primaryKeyValue) => {
  let params = {
  ...
  common.call('GetSysOrganizationTree', params, (res) => {
    ...
    sysOrganizationTree.value.unshift(topParent);
  })
}
...
const init = (options) => {
  //获取组织机构树
  getSysOrganizationTree(options.primaryKeyValue);
  page = detail({
    baseTitle: '组织机构',
    tableName: 'sys_organization',
    getServiceName: 'GetSysOrganization',
    mode: options.mode,
        ...
        <el-row>
          ...
          <el-col :xs="12" :sm="12" :md="12" :lg="12">
            <el-form-item label="上级" prop="parentId">
              <el-tree-select v-model="page.dataEntity.value.parentId" :data="sysOrganizationTree" check-strictly
                placeholder="请选择上级" :render-after-expand="false" />
            </el-form-item>
          </el-col>
          <el-col :xs="12" :sm="12" :md="12" :lg="12">
