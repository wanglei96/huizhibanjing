<script setup>
import {ref} from 'vue';
import SysOrganizationDetail from './SysOrganizationDetail.vue';
...
const list = management({
  ...
  getListServiceName: 'GetViewSysOrganizationList',
...
<template>
  <div class="basic-list">
    <SysOrganizationDetail ref="refDetail" @reload-data="list.loadData"/>
