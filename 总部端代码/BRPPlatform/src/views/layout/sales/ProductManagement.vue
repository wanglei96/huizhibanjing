...
<template>
  <div class="basic-list">
    <ProductDetail ref="refDetail" @reload-data="list.loadData"/>
    ...
    <el-card shadow="never">
      ...
      <el-table ref="multipleTableRef" :data="list.dataList.value" style="width: 100%" border
        ...
        <el-table-column property="name"  label="商品名称" width="180"/>
        <el-table-column property="price" sortable="custom" label="价格"/>
