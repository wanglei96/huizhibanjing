        ...
        <el-row>
          <el-col :xs="12" :sm="12" :md="12" :lg="12">
            <el-form-item label="商品名称" prop="name">
              <el-input v-model="page.dataEntity.value.name" placeholder="请输入商品名称"></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="12" :sm="12" :md="12" :lg="12">
            <el-form-item label="商品价格" prop="price">
              <el-input v-model.number="page.dataEntity.value.price" placeholder="请输入商品价格"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
