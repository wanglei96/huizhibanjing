...
import BatchBookTagExcel from './BatchBookTagExcel.vue'

const batchBookTagExcelRef = ref()
...
<template>
  <div class="user">
    ...
    <CombineBookTag ref="combineBookTagRef" @reload-data="list.loadData" />
    <BatchBookTagExcel ref="batchBookTagExcelRef" @reload-data="list.loadData" />
        ...
        <el-row>
          <el-col :span="18">
            ...
            <el-button type="primary" @click="combineBookTagRef.init(list.primaryKeyValueArray.value)">
              合并标签</el-button>
            <!-- <el-button type="warning" @click="batchBookTagExcelRef.init()">批量录入新书</el-button> -->
          </el-col>
          <el-col :span="6">
          </el-col>
        </el-row>
