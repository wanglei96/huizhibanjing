...
const list = management({
  ...
  condition: "is_cancel is not true",
  refDetail
})
  ...
  ElMessageBox.confirm(
    ...
    .then(() => {
      let params = {
        ...
        cancelMobilePhone: row.mobilePhone,
        cancelOperator: common.getLocalStorage('trueName')
      }
      common.call('CancelMember', params, (res) => {
        list.loadData();
      })
    })
    .catch(() => {
  ...
  <div class="user">
    <el-card shadow="never" class="search-card">
      <el-form ref="refSearchForm" :model="list.parameters">
        <el-row type="flex" :gutter="20">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6">
            <el-form-item label="会员手机号" prop="mobilePhone">
    ...
    <el-card shadow="never" class="user-list-card">
      <el-table ref="multipleTableRef" :data="list.dataList.value" style="width: 100%"
        ...
        <el-table-column property="mobilePhone" label="手机号" align="center" />
        ...
        <el-table-column label="操作" align="center" width="100">
          <template #default="scope">
            <el-space spacer="|" style="color: #999" wrap>
              <el-link type="danger" @click="cancelRow(scope.row)">删除</el-link>
            </el-space>
          </template>
        </el-table-column>
      </el-table>
