...
const list = management({
  ...
  getListServiceName: 'GetBookBorrowTotal',
  refDetail,
...
/* function exportDataList() {
  ...
  data.exportName = 'BookBorrowTotal'
...
function exportDataList() {
  ...
  params.exportName = 'BookBorrowTotal'
  params.pageIndex = 0
  params.pageSize = 1000000
  params.orderBy = 'borrow_count desc'
  ...
  <div class="basic-list">
    ...
    <el-card shadow="never">
      <el-table ref="multipleTableRef" :data="list.dataList.value" style="width: 100%" border
        ...
        <el-table-column property="borrowCount" label="借阅次数" sortable="custom" />
