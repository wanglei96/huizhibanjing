...
const list = management({
  orderBy: 'subscription_count desc,book_name',
  getListServiceName: 'GetBorrowNoticeTotal',
  refDetail,
...
function exportDataList() {
  ...
  params.exportName = 'BorrowNoticeTotal'
  params.pageIndex = 0
  params.pageSize = 1000000
  params.orderBy = 'subscription_count desc'
  ...
  <div class="basic-list">
      ...
      <el-form ref="refSearchForm" :model="list.parameters">
        <el-row :gutter="20" type="flex">
          <el-col :xs="24" :sm="12" :md="8" :lg="6" style="margin-bottom: 10px">
            <el-form-item label="创建时间范围" prop="dpSearchCreateTime">
    ...
    <el-card shadow="never">
      <el-table ref="multipleTableRef" :data="list.dataList.value" style="width: 100%" border
        ...
        <el-table-column property="subscriptionCount" label="点击次数" sortable="custom" />
      </el-table>
