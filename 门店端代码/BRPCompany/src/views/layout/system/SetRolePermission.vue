...
function getRolePermissionTree(id) {
  companyRoleId.value = id;
  detailFormVisible.value = true;
  common.call('GetCompanyRolePermissionTree', {companyRoleId: id}, (res) => {
...
function save() {
  ...
  common.call('SaveCompanyRolePermissions', {companyRoleId: companyRoleId.value, permissions: permissions.value})
}
