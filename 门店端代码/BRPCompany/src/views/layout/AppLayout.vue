...
import BorrowReturnBook from '/src/views/layout/bookOrder/BorrowReturnBook.vue';
...
//找书出库
provide('handleStockOut', handleStockOut);

function handleStockOut() {
  router.push('/book/BookOutOrder');
}
...
function openBook(param) {
  router.push('/book/BookManagement?skuId=' + param);
}

//查看借阅记录
provide('openBorrowLog', openBorrowLog);

function openBorrowLog(param) {
  router.push('/book/BorrowLogManagement?bookId=' + param);
}

//查看标记记录
provide('openBookDamageLog', openBookDamageLog);

function openBookDamageLog(param) {
  router.push('/book/BookDamageManagement?bookId=' + param);
}
        ...
        <el-main>
          ...
          <div class="tabs">
            ...
            <div class="tabs content">
              <router-link v-for="item in tabsStore.getTabs" :key="item.tabs" class="linkTabs" :to="item.path"
                active-class="active">
            ...
            <div class="container">
              ...
              <RouterView v-slot="{ Component }">
                <transition :name="store.getConfig.animation || 'fade'" mode="out-in">
                  <KeepAlive include="BorrowReturnBook,ScanBookInOrder">
