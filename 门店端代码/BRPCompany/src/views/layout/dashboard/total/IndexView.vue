...
const notBorrowedForFourteenDays = () => {
  debugger
  const storageKey = 'notBorrowedForFourteenDaysIds';
  localStorage.setItem(storageKey, memberInfoTotal.value.notBorrowedForFourteenDaysIds);
  const idsString = JSON.stringify(memberInfoTotal.value.notBorrowedForFourteenDaysIds);
  router.push({
    path: '/member/memberCardQuery/MemberCardQueryView',
    query: {
      memberCardIds: storageKey
    }
  })
}
</script>
    ...
    <el-card shadow="hover">
      <div class="top-box">
        <div style="text-align: center">
          <router-link :to="{
            path: '/member/memberCardQuery/MemberCardQueryView',
            query: { memberCardIds: memberInfoTotal.notBorrowedForFourteenDaysIds || 0 }
          }" style="text-decoration: none;">
            <div style="font-size: 20px; margin-bottom: 10px">{{ memberInfoTotal.notBorrowedForFourteenDaysCount }}
            </div>
            <div>14天未借阅会员</div>
          </router-link>
        </div>
        <!-- <div style="text-align: center" @click="notBorrowedForFourteenDays">
        ...
        <div style="text-align: center">
          <router-link :to="{
            path: '/member/memberCardQuery/MemberCardQueryView',
            query: { memberCardIds: memberInfoTotal.expiredNotCommunicaIds || 0 }
          }" style="text-decoration: none;">
        ...
        <div style="text-align: center">
          <router-link :to="{
            path: '/member/memberCardQuery/MemberCardQueryView',
            query: { memberCardIds: memberInfoTotal.expiringThirtyDayIds || 0 }
          }" style="text-decoration: none;">
        ...
        <div style="text-align: center">
          <router-link :to="{
            path: '/member/memberCardQuery/MemberCardQueryView',
            query: { memberCardIds: memberInfoTotal.suspendMemberIds || 0 }
          }" style="text-decoration: none;">
            <div style="font-size: 20px; margin-bottom: 10px">
        ...
        <div style="text-align: center">
          <router-link :to="{
            path: '/member/memberCardQuery/MemberCardQueryView',
            query: { memberCardIds: memberInfoTotal.expiredBooksIds || 0 }
          }" style="text-decoration: none;">
            <div style="font-size: 20px; margin-bottom: 10px">
        ...
        <div style="text-align: center">
          <router-link :to="{
            path: '/member/memberCardQuery/MemberCardQueryView',
            query: { memberCardIds: memberInfoTotal.expiredIds || 0 }
          }" style="text-decoration: none;">
