...
import RequiredBookDetail from './RequiredBookDetail.vue'
...
<template>
  <div class="basic-list">
    <RequiredBookDetail ref="refDetail" @reload-data="list.loadData" />
      ...
      >
        ...
        <el-table-column property="imageFilePath" label="图书封面" width="150" align="center">
          <template #default="scope">
            <div>
              <el-image
                :src="scope.row.bookSkuImageFilePath"
                fit="contain"
                :preview-src-list="[scope.row.bookSkuImageFilePath]"
                preview-teleported
              >
                <template #error>
        ...
        <el-table-column property="bookName" label="名称" />
        <el-table-column property="required_book_category_name" label="必读书单分类" />
