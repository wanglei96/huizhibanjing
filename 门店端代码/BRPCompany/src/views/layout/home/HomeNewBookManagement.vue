...
import HomeNewBookDetail from './HomeNewBookDetail.vue'
...
const list = management({
  tableName: 'homeNewBook',
  orderBy: 'display_order',
  getListServiceName: 'GetViewHomeNewBookList',
  refDetail,
...
<template>
  <div class="basic-list">
    <HomeNewBookDetail ref="refDetail" @reload-data="list.loadData" />
    <el-card shadow="never" class="search-card">
      <el-form ref="refSearchForm" :model="list.parameters">
        <el-row type="flex">
          <el-col :xs="24" :sm="12" :md="8" :lg="6" style="margin-bottom: 10px">
            <el-form-item label="ISNB" prop="bookISBN">
              <el-input placeholder="请输入..." v-model="list.parameters.bookISBN" @keydown.enter.prevent=list.query></el-input>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="6" style="margin-bottom: 10px">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6" style="margin-bottom: 10px">
            <el-form-item label="是否启用" prop="condition">
              <el-select v-model="list.parameters.condition">
                <el-option label="是" value="enabled is true"></el-option>
                <el-option label="否" value="enabled is not true"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="6" style="margin-bottom: 10px">
    ...
    <el-card shadow="never">
      ...
      <el-table ref="multipleTableRef" :data="list.dataList.value" style="width: 100%" border
        ...
        <el-table-column property="imageFilePath" label="图书封面" width="150" align="center">
        ...
        <el-table-column property="book_sku_book_name" label="图书名称" />
        <el-table-column property="book_ISBN" label="ISBN" />
