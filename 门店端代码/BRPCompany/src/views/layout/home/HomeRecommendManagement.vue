...
import HomeRecommendDetail from './HomeRecommendDetail.vue'
...
const list = management({
  ...
  getListServiceName: 'GetViewHomeRecommendList',
  refDetail,
...
function getCondition() {
  return 'id in (select club_activity_id from home_recommend where company_id=' + localStorage.getItem('companyId') + ')'
}
...
<template>
  <div class="basic-list">
    <HomeRecommendDetail ref="refDetail" @reload-data="list.loadData" />
    <el-card shadow="never" class="search-card">
      <el-form ref="refSearchForm" :model="list.parameters">
        <el-row type="flex">
          ...
          <el-col :xs="24" :sm="12" :md="8" :lg="6" style="margin-bottom: 10px">
            <el-form-item label="俱乐部活动" prop="clubActivityId">
              <database-select table-name="club_activity" value-field-name="id" textFieldName="name"
                :condition="getTableByCompanyId()" v-model="list.parameters.clubActivityId"></database-select>
            </el-form-item>
          </el-col>
          <el-col :xs="24" :sm="12" :md="8" :lg="6" style="margin-bottom: 10px">
            <el-form-item>
    ...
    <el-card shadow="never">
      ...
      <el-table ref="multipleTableRef" :data="list.dataList.value" style="width: 100%" border
        ...
        <el-table-column property="imageFilePath" label="活动封面" width="150" align="center">
