...
const rules = reactive({
  ...
  imageFileId: [{ required: true, message: '请上传图标', trigger: 'blur' }],
  displayOrder: [
    { required: true, message: '请输入排序', trigger: 'blur' },
    { validator: common.positiveInteger, trigger: 'blur' }
  ]
})
const getRequiredBookCategoryCondition = ref('')
getRequiredBookCategoryCondition.value = `company_id=${localStorage.getItem('companyId')}`
</script>
<template>
  <div>
    ...
    >
      ...
      >
        <el-row >
          ...
          <el-col :xs="12" :sm="12" :md="12" :lg="12">
            <el-form-item label="上级分类" prop="path" label-width="auto">
              <TreeSelect
                table-name="required_book_category"
                v-model="page.dataEntity.value.parentId"
                :condition="getRequiredBookCategoryCondition"
              ></TreeSelect>
            </el-form-item>
          </el-col>
          <el-col :xs="12" :sm="12" :md="12" :lg="12">
          ...
          <el-col>
            <el-form-item label="描述" prop="description">
              <el-input
                ...
                rows="4"
                style="width: 100%"
                v-model.number="page.dataEntity.value.description"
                placeholder="请输入描述"
              ></el-input>
            </el-form-item>
          </el-col>
