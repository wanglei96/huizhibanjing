...
import HomeRandomBookDetail from './HomeRandomBookDetail.vue'
...
const list = management({
  tableName: 'home_random_book',
  orderBy: 'create_time desc',
  getListServiceName: 'GetViewHomeRandomBookList',
  refDetail,
...
<template>
  <div class="basic-list">
    <HomeRandomBookDetail ref="refDetail" @reload-data="list.loadData" />
    <el-card shadow="never">
      ...
      <el-table ref="multipleTableRef" :data="list.dataList.value" style="width: 100%" border
        ...
        <el-table-column property="imageFilePath" label="图片" width="150" align="center">
        ...
        <el-table-column property="ageGroupNames" label="年龄段" />
