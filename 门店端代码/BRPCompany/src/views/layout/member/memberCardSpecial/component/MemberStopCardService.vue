<template>
  ...
  <el-form
    ref="MemberStopCardServiceFormRef"
    :model="MemberStopCardServiceForm"
    :rules="rules"
    :size="formSize"
    status-icon>
	 <el-tabs v-model="activeName" class="demo-tabs" @tab-click="handleClick">
		...
		<el-tab-pane label="赠送停卡次数" name="third">
		 ...
		 <el-form-item label="开始时间" prop="stopDate">
		    <el-date-picker
		           v-model="MemberStopCardServiceForm.stopDate"
		  ...
		  <el-form-item label="停卡天数" prop="stopDays">
		    <el-input type="number" v-model="MemberStopCardServiceForm.stopDays" placeholder="请输入停卡天数" @input="handleStopDaysChange"/>
		  </el-form-item>
		 
		 <el-form-item label="结束时间" prop="stopEndDate">
		    <el-date-picker
			disabled
		           v-model="MemberStopCardServiceForm.stopEndDate"
		 		  value-format="YYYY-MM-DD HH:mm:ss"
		           type="date"
		           :size="size"
		         />
