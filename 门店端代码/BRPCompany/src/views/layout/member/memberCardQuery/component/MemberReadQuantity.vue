	...
	<div>
		<el-dialog destroy-on-close :close-on-click-modal="false" v-model="dialogFormVisible" :title="msg" width="700"
			...
			<el-form ref="MemberReadQuantityFormRef" :model="MemberReadQuantityForm" :rules="rules" label-width="150px"
				...
				<el-form-item label="增减借阅本数" prop="quantity">
					<el-input type="number" v-model="MemberReadQuantityForm.quantity" placeholder="减少的数字前加-" />
				</el-form-item>

				<el-form-item label="类型" prop="memberBorrowQuantityTypeCode">
				...
				<el-form-item label="有效期" prop="validDate">
					...
					:disabled="MemberReadQuantityForm.memberBorrowQuantityTypeCode==='Permanent'"
				...
				<el-form-item label="增减借阅本数原因" prop="borrowRemark">
...
const submitForm = async (formEl: FormInstance | undefined) => {
	...
	await formEl.validate((valid, fields) => {
		if (valid) {
			if(MemberReadQuantityForm.memberBorrowQuantityTypeCode==='Temporary'){
