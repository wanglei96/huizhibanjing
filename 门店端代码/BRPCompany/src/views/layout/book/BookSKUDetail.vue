...
const uploadPath = ref(
  `/api/Service?serviceName=UploadFile`
);
...
const rules = reactive({
  ...
  ISBN: [
    { required: true, message: 'ISBN', trigger: 'change' },
...
function onEditorReady() {
  // Wait for a short delay before restoring scroll position
  setTimeout(() => {
...
<template>
  <div>
    <el-dialog destroy-on-close :close-on-click-modal="false" v-if="detailFormVisible" v-model="detailFormVisible"
      ...
      <el-form :model="page.dataEntity.value" :rules="rules" ref="refDataEntityForm" :label-position="'right'"
        ...
        <el-scrollbar height="500px">
          ...
          <el-row>
            ...
            <el-col :xs="6" :sm="6" :md="6" :lg="6">
              <el-form-item label="系列" prop="bookSeriesCode">
            ...
            <el-col :xs="6" :sm="6" :md="6" :lg="6">
              <el-form-item label="语言分类" prop="languageCode">
                <el-select class="form-item-width" v-model="page.dataEntity.value.languageCode" placeholder="请选择语言分类"
          ...
          <el-row>
            <el-col :xs="24" :sm="24" :md="24" :lg="24">
              <el-form-item label="备注" prop="remark">
                <el-input v-model="page.dataEntity.value.remark" type="textarea" placeholder="请输入备注"
                  style="width: 99%;"></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
