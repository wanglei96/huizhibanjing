<script setup>
import DeliverAreaEdit from './component/DeliverAreaEdit.vue'
...
function getDataList(nameQuery) {
	let param = {
	...
	common.call("GetDeliverAreaList", param, function (result) {
		...
		<el-card shadow="never" class="user-list-card">
			<template #header>
				<div class="card-header">
					<div>
						<el-button type="primary" @click="DeliverAreaEditRef.init('add')">
			...
			<el-table :data="tableData" style="width: 100%">
				<el-table-column property="name" label="配送大区" align="center" />
				<el-table-column property="description" label="描述" align="center" />
				<el-table-column label="操作" align="center">
					<template #default="scope">
						<el-space spacer="|" style="color: #999" wrap>
							<el-link type="primary" :id="scope.row.id"
								@click="DeliverAreaEditRef.init('edit', scope.row)">修改</el-link>
							<el-link type="danger" @click="DeliverAreaDel(scope.row.id)">删除</el-link>
						</el-space>
					</template>
				</el-table-column>
			</el-table>
