	...
	<view>
		...
		<view class="container">
			<block v-for="(item,index) in bookSkuInfoList" :key="index">
				...
				<view>
					<view v-for="(ite, indexs) in item.booksList" :key="indexs" class="booksListPanel">
						<view style="position: relative;height: 100% ;width: 100%;" @tap.stop="clickToBooksDetail(ite)"> <!-- overflow: hidden; -->
