...
if (debug) {
	adminRootUrl = "https://admin.brp.rome8.com";   //https://admin.brp.rome8.com 正式地址     https://admin.fu7.net/BRPAdmin  测试地址  
}
//服务接口地址
...
var imageRootUrl = "https://admin.brp.rome8.com/wyb/static/";
//充值通知地址
