...
public class ViewMemberBrowsedStoryVideo extends DataEntity implements Cloneable
{
    ...
    public  ViewMemberBrowsedStoryVideo copy()    
    {
        ViewMemberBrowsedStoryVideo entity = null;
        try        
        {
            entity = (ViewMemberBrowsedStoryVideo) super.clone();
        }
