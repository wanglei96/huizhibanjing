...
public class MemberCollectClubActivity extends DataEntity implements Cloneable
{
    ...
    public  MemberCollectClubActivity copy()    
    {
        MemberCollectClubActivity entity = null;
        try        
        {
            entity = (MemberCollectClubActivity) super.clone();
        }
