...
public class ViewSettlementOrder extends DataEntity implements Cloneable
{
    ...
    private  String settlementOrderStatusName;//单据状态;
    ...
    public  void setSettlementOrderStatusName(String settlementOrderStatusName)    
    {
        this.settlementOrderStatusName = settlementOrderStatusName;
    }
    public  String getSettlementOrderStatusName()    
    {
        return settlementOrderStatusName;
    }
    public  ViewSettlementOrder copy()    
    {
        ViewSettlementOrder entity = null;
        try        
        {
            entity = (ViewSettlementOrder) super.clone();
        }
