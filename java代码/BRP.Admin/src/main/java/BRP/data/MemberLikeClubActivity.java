...
public class MemberLikeClubActivity extends DataEntity implements Cloneable
{
    ...
    public  MemberLikeClubActivity copy()    
    {
        MemberLikeClubActivity entity = null;
        try        
        {
            entity = (MemberLikeClubActivity) super.clone();
        }
