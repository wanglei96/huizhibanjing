...
public class ViewRefundOrder extends DataEntity implements Cloneable
{
    ...
    private  Boolean isCancelMember;//是否注销会员;
    private  Boolean isCancelBookbox;//是否注销书箱;
    private  Boolean isRecoverBook;//是否恢复图书;
    private  Integer refunderId;//退款人;
    private  Timestamp createTime;//创建时间;
    private  Timestamp updateTime;//更新时间;
    private  String refundTypeName;//退款类型;
    ...
    private  String refunderName;//姓名;
    ...
    public  ViewRefundOrder copy()    
    {
        ViewRefundOrder entity = null;
        try        
        {
            entity = (ViewRefundOrder) super.clone();
        }
