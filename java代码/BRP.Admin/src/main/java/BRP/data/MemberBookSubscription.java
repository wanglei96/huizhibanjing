...
public class MemberBookSubscription extends DataEntity implements Cloneable
{
    ...
    public  MemberBookSubscription copy()    
    {
        MemberBookSubscription entity = null;
        try        
        {
            entity = (MemberBookSubscription) super.clone();
        }
