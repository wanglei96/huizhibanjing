...
public class SalesOrderNotifyHandler extends WxPayNotifyHandler {

    @Override
    public void process(WxPayNoticeContext context) throws Exception {
        Tracer.writeLine("SalesOrderNotifyHandler...");
        ...
        SalesOrderManager.getInstance().paySalesOrderNotify(outTradeNo, wxPayTransactionId);
        Tracer.writeLine("SalesOrderNotifyHandler");
    }
