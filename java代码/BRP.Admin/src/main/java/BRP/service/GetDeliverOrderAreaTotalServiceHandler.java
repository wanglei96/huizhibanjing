...
public class GetDeliverOrderAreaTotalServiceHandler extends ServiceHandler {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer errorProcessingCount =ViewBookOrderManager.getInstance().getCount(sqlCondition+" and error_remark is not null ");
        jDataResult.put("errorProcessingCount",errorProcessingCount);
        Integer stockOutingCount =ViewBookOrderManager.getInstance().getCount(sqlCondition+" and (book_order_borrow_status_code='Submitting' OR book_order_borrow_status_code='StockOuting' )");
        jDataResult.put("stockOutingCount",stockOutingCount);
