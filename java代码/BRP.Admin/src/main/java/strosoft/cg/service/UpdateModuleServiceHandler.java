 ...
 * 添加服务处理类
 */
public class UpdateModuleServiceHandler extends ServiceHandler {
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		CgModule module = (CgModule) ServiceHandlerHelper
		...
		try{
			...
			String originaltModuleName = jData.getString("originaltModuleName");
			...
			String configuration = CreateCodeManager.getInstance().getConfigurationWhenUpdateModule(module,originaltModuleName,projects.get(0)).replace("\\", "\\\\");
