 ...
 * 更新CmsCode基础表服务处理类
 */
public class UpdateCmsCodeNameTableServiceHandler extends ServiceHandler {
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		int result = CmsCodeNameTableManager.getInstance().update(tableName,
				newCmsCodeNameTable);
	...
	private CmsCodeNameTable getEntity(JSONObject jData) throws Exception {
		...
		CmsCodeNameTable newCmsCodeNameTable = CmsCodeNameTableManager
