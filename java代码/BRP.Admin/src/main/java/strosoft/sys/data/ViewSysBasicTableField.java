...
public class ViewSysBasicTableField extends DataEntity implements Cloneable
{
    ...
    private  String sysUiControlName;//;
    private  String sysAlignName;//;
    private  String sysValidationDataTypeName;//;
    private  String sysFieldDataTypeName;//;
    ...
    public  void setSysUiControlName(String sysUiControlName)    
    {
        this.sysUiControlName = sysUiControlName;
    }
    public  String getSysUiControlName()    
    {
        return sysUiControlName;
    }
    public  void setSysAlignName(String sysAlignName)    
    {
        this.sysAlignName = sysAlignName;
    }
    public  String getSysAlignName()    
    {
        return sysAlignName;
    }
    public  void setSysValidationDataTypeName(String sysValidationDataTypeName)    
    {
        this.sysValidationDataTypeName = sysValidationDataTypeName;
    }
    public  String getSysValidationDataTypeName()    
    {
        return sysValidationDataTypeName;
    }
    public  void setSysFieldDataTypeName(String sysFieldDataTypeName)    
    {
        this.sysFieldDataTypeName = sysFieldDataTypeName;
    }
    public  String getSysFieldDataTypeName()    
    {
        return sysFieldDataTypeName;
    }
    public  ViewSysBasicTableField copy()    
    {
        ViewSysBasicTableField entity = null;
        try        
        {
            entity = (ViewSysBasicTableField) super.clone();
        }
