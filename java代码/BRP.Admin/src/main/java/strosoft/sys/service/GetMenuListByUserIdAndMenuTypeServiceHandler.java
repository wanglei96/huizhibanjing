 ...
 * 取得用户菜单列表
 */
public class GetMenuListByUserIdAndMenuTypeServiceHandler extends ServiceHandler {
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		Integer sysUserId = JsonHelper.getInt(jData, "sysUserId", "SysUserId",
				"sys_user_id");
		...
		ArrayList<SysMenu> lstSysMenu = SysMenuManager.getInstance()
				.getListBySysUserIdAndMenuTypeCode(sysUserId,menuTypeCode);
		//添加父菜单
