...
public class ViewMemberLikeStoryVideo extends DataEntity implements Cloneable
{
    ...
    public  ViewMemberLikeStoryVideo copy()    
    {
        ViewMemberLikeStoryVideo entity = null;
        try        
        {
            entity = (ViewMemberLikeStoryVideo) super.clone();
        }
