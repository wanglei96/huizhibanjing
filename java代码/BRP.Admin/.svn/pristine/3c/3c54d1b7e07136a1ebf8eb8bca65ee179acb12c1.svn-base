...
public class SysSetting extends DataEntity implements Cloneable
{
    private  String code;//;
    private  String name;//;
    private  String value;//;
    private  String sysDataTypeCode;//;
    private  String sysSettingCategoryCode;//;
    private  String sysUiControlCode;//;
    ...
    public  SysSetting copy()    
    {
        SysSetting entity = null;
        try        
        {
            entity = (SysSetting) super.clone();
        }
