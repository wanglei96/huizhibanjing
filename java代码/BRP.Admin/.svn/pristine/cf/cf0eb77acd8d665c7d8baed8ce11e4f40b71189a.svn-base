...
public class DataMasterGetListPageConditionOrderByMethod extends MethodInfo {
	...
	public String getMethodBody() {
		...
		sb.append("> list = null;");
		sb.append("try{");
		sb.append("list = getList(sqlSession, condition, orderBy, pageIndex, pageSize);");
	...
	public void setMethodParameters() {
		...
		// 排序
		MethodParameter orderByMethodParameter = new MethodParameter();
		orderByMethodParameter.setName("orderBy");
		orderByMethodParameter.setType("String");
		parameters.add(orderByMethodParameter);
		// 当前页
