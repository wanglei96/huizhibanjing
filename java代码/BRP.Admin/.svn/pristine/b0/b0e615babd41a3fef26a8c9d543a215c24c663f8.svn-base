...
public class ViewCmsContentInfo extends DataEntity implements Cloneable
{
    private  Integer id;//ID;
    private  Integer cmsContentLanguageId;//多语言栏目ID;
    private  String cmsLanguageCode;//语言编码;
    private  String cmsLanguageName;//语言名;
    private  String title;//标题;
    private  String subTitle;//副标题;
    private  Integer thumbFileId;//图片ID;
    private  String thumbFilePath;//图片路径;
    private  String thumbFileName;//图片名;
    private  String cmsContentFilePath;//内容文件地址;
    ...
    private  String attachmentFilePath;//附件路径;
    ...
    private  Integer isTop;//是否顶置;
    private  Integer isHighlight;//是否高亮;
    private  Timestamp publishDate;//新闻日期;
    private  Integer cmsChannelId;//栏目ID;
    private  String cmsChannelName;//栏目名;
    private  String cmsContentTypeCode;//内容类型编码;
    private  String cmsContentStatusCode;//内容状态编码;
    private  String cmsContentStatusName;//内容状态名;
    private  String remark;//备注;
    private  Integer displayOrder;//排序;
    private  Integer cmsSiteId;//站点ID;
    private  Integer cmsContentTemplateId;//内容模板ID;
    private  String cmsContentTemplateUrl;//内容模板文件路径;
    private  String encode;//编码;
    private  String createFilePath;//内容文件地址;
    ...
    public  void setCmsContentLanguageId(Integer cmsContentLanguageId)    
    {
        this.cmsContentLanguageId = cmsContentLanguageId;
    }
    public  Integer getCmsContentLanguageId()    
    {
        return cmsContentLanguageId;
    }
    ...
    public  void setCmsLanguageName(String cmsLanguageName)    
    {
        this.cmsLanguageName = cmsLanguageName;
    }
    public  String getCmsLanguageName()    
    {
        return cmsLanguageName;
    }
    ...
    public  void setCmsChannelName(String cmsChannelName)    
    {
        this.cmsChannelName = cmsChannelName;
    }
    public  String getCmsChannelName()    
    {
        return cmsChannelName;
    }
    public  void setCmsContentTypeCode(String cmsContentTypeCode)    
    {
        this.cmsContentTypeCode = cmsContentTypeCode;
    }
    public  String getCmsContentTypeCode()    
    {
        return cmsContentTypeCode;
    }
    ...
    public  void setCmsContentStatusName(String cmsContentStatusName)    
    {
        this.cmsContentStatusName = cmsContentStatusName;
    }
    public  String getCmsContentStatusName()    
    {
        return cmsContentStatusName;
    }
    ...
    public  void setCmsContentTemplateUrl(String cmsContentTemplateUrl)    
    {
        this.cmsContentTemplateUrl = cmsContentTemplateUrl;
    }
    public  String getCmsContentTemplateUrl()    
    {
        return cmsContentTemplateUrl;
    }
    ...
    public  ViewCmsContentInfo copy()    
    {
        ViewCmsContentInfo entity = null;
        try        
        {
            entity = (ViewCmsContentInfo) super.clone();
        }
