...
import strosoft.app.util.MatrixToImageWriter;
...
public class BarCodeUtils {
    ...
    public static BufferedImage getCodeWithWords(BufferedImage codeImage, String bottomStr, String topLeftStr,
        ...
        //picImage.getGraphics().drawImage(codeImage.getScaledInstance(pictureWidth, pictureHeight, java.awt.Image.SCALE_SMOOTH), 0, 0, null);
