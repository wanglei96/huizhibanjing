        ...
        try {
            ...
            if (jsonArray != null && jsonArray.size() > 0) {
                for (int i = 0; i < jsonArray.size(); i++) {
                    ...
                    //获取减去天数的时间
                    LocalDateTime newCardLocalDateTime = theNewMemberCard.getExpireDate().toLocalDateTime();
                    LocalDateTime newLocalDateTime = newCardLocalDateTime.minus(days, ChronoUnit.DAYS);
                    Timestamp agoNewCardExpiryTime = Timestamp.valueOf(newLocalDateTime);
                    ...
                    newMemberLog.setAgoExpiryTime(agoNewCardExpiryTime);
                    ...
                    //获取减去天数的时间
                    LocalDateTime oldCardLocalDateTime = theOldMemberCard.getExpireDate().toLocalDateTime();
                    LocalDateTime oldLocalDateTime = oldCardLocalDateTime.minus(days, ChronoUnit.DAYS);
                    Timestamp agoOldCardExpiryTime = Timestamp.valueOf(oldLocalDateTime);
                    ...
                    newReferrerLog.setAgoExpiryTime(agoOldCardExpiryTime);
