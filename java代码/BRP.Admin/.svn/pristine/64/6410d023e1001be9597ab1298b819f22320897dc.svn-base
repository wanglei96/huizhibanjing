 ...
 * 添加服务处理类
 */
public class AddModuleServiceHandler extends ServiceHandler {
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			String configuration = CreateCodeManager.getInstance().getConfigurationWhenAddModule(module,projects.get(0)).replace("\\", "\\\\");
