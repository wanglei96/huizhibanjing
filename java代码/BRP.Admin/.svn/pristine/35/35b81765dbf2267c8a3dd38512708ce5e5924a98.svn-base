...
public class ViewBookcaseOrder extends DataEntity implements Cloneable
{
    ...
    public  ViewBookcaseOrder copy()    
    {
        ViewBookcaseOrder entity = null;
        try        
        {
            entity = (ViewBookcaseOrder) super.clone();
        }
