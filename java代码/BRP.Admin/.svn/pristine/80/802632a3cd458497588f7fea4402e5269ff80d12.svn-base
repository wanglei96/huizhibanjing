...
public class AddCmsChannelSysRolePermissionServiceHandler extends ServiceHandler{
	...
	public void process(HttpServletRequest request, HttpServletResponse response)
		...
		JSONObject values = jData.getJSONObject("values");
		SysRoleCmsChannelPermissionManager.getInstance().add(sysRoleId, values);
