...
public class TableMasterGetListByForeignKeyMethod extends MethodInfo{
	...
	public String getMethodBody(){
		...
		sb.append("e.printStackTrace();sqlSession.rollback();throw e;} finally {sqlSession.close();}return entitys;");
		return sb.toString();
	}
