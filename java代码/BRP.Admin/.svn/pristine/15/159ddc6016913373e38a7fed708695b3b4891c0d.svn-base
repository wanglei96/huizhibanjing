...
public class BookBorrowedReturnThirtyScheduledTask extends ScheduledTask {
    ...
    protected void process() {
        try {
            ...
            if (isMidnight) {
                MessageManager.getInstance().sendBookBorrowedReturnMessage(MessageTypeCodes.ThirtyNotReturned);
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
