...
public class ViewMemberCollectClubActivity extends DataEntity implements Cloneable
{
    ...
    public  ViewMemberCollectClubActivity copy()    
    {
        ViewMemberCollectClubActivity entity = null;
        try        
        {
            entity = (ViewMemberCollectClubActivity) super.clone();
        }
