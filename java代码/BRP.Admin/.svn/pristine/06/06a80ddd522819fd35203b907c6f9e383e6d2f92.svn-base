...
public class ViewRequiredBookCategory extends DataEntity implements Cloneable
{
    ...
    public  ViewRequiredBookCategory copy()    
    {
        ViewRequiredBookCategory entity = null;
        try        
        {
            entity = (ViewRequiredBookCategory) super.clone();
        }
