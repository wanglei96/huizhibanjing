...
public class ExportMemberBorrowBookTotalHandler extends ExportHandler {
    /**
     * 取得数据
     *
     * @param context
    ...
    protected Object getData(ExportContext context) throws Exception {
        ...
        //获得数据
        ArrayList<LinkedHashMap<String, Object>> alData = MemberManager.getInstance().getMemberBorrowBookTotal(
                companyId, cardNo, memberName, mobilePhone, createTimeBegin, createTimeEnd, orderBy, pageIndex, pageSize
        );
        return alData;
    }
}
