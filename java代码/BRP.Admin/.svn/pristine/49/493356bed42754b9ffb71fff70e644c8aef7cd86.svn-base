...
public class ViewMemberLikeClubActivity extends DataEntity implements Cloneable
{
    ...
    public  ViewMemberLikeClubActivity copy()    
    {
        ViewMemberLikeClubActivity entity = null;
        try        
        {
            entity = (ViewMemberLikeClubActivity) super.clone();
        }
