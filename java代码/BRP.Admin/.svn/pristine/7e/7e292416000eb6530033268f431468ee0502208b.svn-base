...
public class TableMasterBatchDeleteByEntityMethod extends MethodInfo{
	...
	public String getMethodBody(){
		...
		sb.append("try{");
		sb.append("rows = batchDeleteByEntity(sqlSession,list);sqlSession.commit();");
	...
	public void setMethodParameters(){
		...
		parameter.setType("List<DataEntity>");
