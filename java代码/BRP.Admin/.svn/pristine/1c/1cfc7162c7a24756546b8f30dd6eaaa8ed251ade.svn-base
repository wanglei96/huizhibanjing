 ...
 * 取得用户菜单列表
 */
public class GetCompanyMenuListServiceHandler extends ServiceHandler {
    ...
    public void process(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer companyUserId = JsonHelper.getInt(jData, "companyUserId");
        String menuTypeCode = jData.getString("menuTypeCode");

        // 获取查询的菜单列表
        ArrayList<SysMenu> lstSysMenu = SysMenuManager.getInstance()
                .getListByComapnyUserIdAndMenuTypeCode(companyUserId, menuTypeCode);
        //获取所有菜单列表
    ...
    private static ArrayList<SysMenu> getTopMenusByParentId(ArrayList<SysMenu> allSysMenu) throws Exception {
        ...
        /*SysMenu result = allSysMenu.stream()
                ...
                .orElse(null);*/
        List<SysMenu> lstSysMenu = SysMenuManager.getInstance().getList("value='Company'");
