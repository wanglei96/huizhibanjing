...
public class ViewCmsContent extends DataEntity implements Cloneable
{
    private  Integer id;//;
    ...
    private  String cmsChannelName;//标题;
    private  Integer cmsSiteId;//所属站点ID;
    private  Integer cmsContentTemplateId;//内容模板类型;
    private  String cmsChannelCode;//;
    private  String cmsContentTemplatePath;//;
    private  String cmsContentTemplateUrl;//;
    ...
    private  String cmsContentStatusName;//;
    ...
    public  void setCmsChannelCode(String cmsChannelCode)    
    {
        this.cmsChannelCode = cmsChannelCode;
    }
    public  String getCmsChannelCode()    
    {
        return cmsChannelCode;
    }
    public  void setCmsContentTemplatePath(String cmsContentTemplatePath)    
    {
        this.cmsContentTemplatePath = cmsContentTemplatePath;
    }
    public  String getCmsContentTemplatePath()    
    {
        return cmsContentTemplatePath;
    }
    ...
    public  ViewCmsContent copy()    
    {
        ViewCmsContent entity = null;
        try        
        {
            entity = (ViewCmsContent) super.clone();
        }
