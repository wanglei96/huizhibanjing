...
public class ExportBorrowNoticeTotalHandler extends ExportHandler {
    /**
     * 取得数据
     *
     * @param context
    ...
    protected Object getData(ExportContext context) throws Exception {
        ...
        //获得数据
        ArrayList<LinkedHashMap<String, Object>> alData = BookSkuManager.getInstance().getBorrowNoticeTotal(
