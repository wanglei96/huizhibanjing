...
public class ViewMessageTemplate extends DataEntity implements Cloneable
{
    ...
    public  ViewMessageTemplate copy()    
    {
        ViewMessageTemplate entity = null;
        try        
        {
            entity = (ViewMessageTemplate) super.clone();
        }
