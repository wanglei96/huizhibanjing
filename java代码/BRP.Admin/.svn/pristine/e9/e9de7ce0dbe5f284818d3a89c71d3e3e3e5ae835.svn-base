...
public class GetBookStocksLogTotalServiceHandler extends GetListServiceHandler {
    public void process(HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        ArrayList<LinkedHashMap<String, Object>> alData  = BookSkuManager.getInstance().getBookStocksLogTotal(companyId, bookName, createTimeBegin, createTimeEnd, orderBy, pageIndex, pageSize);
